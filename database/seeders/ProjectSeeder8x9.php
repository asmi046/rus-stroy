...
class ProjectSeeder8x9 extends Seeder
{
        ...
        $data = [
            [
                ...
                'gallery' => [
                    ...
                    '/tmp_data/projects/pr_181/p181_photo_2.JPG',
                ],
                'layout' => [],
                'type' => 'Дом',
                'floors' => 1,
            ...
            [
                ...
                'gallery' => [
                    ...
                    '/tmp_data/projects/pr_182/p182_photo_2.JPG',
                    '/tmp_data/projects/pr_182/p182_photo_3.JPG',
                    '/tmp_data/projects/pr_182/p182_photo_4.JPG',
                    '/tmp_data/projects/pr_182/p182_photo_5.JPG',
                    '/tmp_data/projects/pr_182/p182_photo_6.JPG',
                    '/tmp_data/projects/pr_182/p182_photo_7.JPG',
                    '/tmp_data/projects/pr_182/p182_photo_8.JPG',
                    '/tmp_data/projects/pr_182/p182_photo_9.JPG',
                    '/tmp_data/projects/pr_182/p182_photo_10.JPG',
                ],
                'layout' => [],
                'type' => 'Дом',
                'floors' => 2,
            ...
            [
                ...
                'gallery' => [
                    ...
                    '/tmp_data/projects/pr_183/p183_photo_2.JPG',
                    '/tmp_data/projects/pr_183/p183_photo_3.JPG',
                    '/tmp_data/projects/pr_183/p183_photo_4.JPG',
                    '/tmp_data/projects/pr_183/p183_photo_5.JPG',
                    '/tmp_data/projects/pr_183/p183_photo_6.JPG',
                    '/tmp_data/projects/pr_183/p183_photo_7.JPG',
                    '/tmp_data/projects/pr_183/p183_photo_8.JPG',
                    '/tmp_data/projects/pr_183/p183_photo_9.JPG',
                ],
                'layout' => [],
                'type' => 'Дом',
                'floors' => 2,
            ...
            [
                ...
                'gallery' => [
                    ...
                    '/tmp_data/projects/pr_184/p184_photo_2.JPG',
                    '/tmp_data/projects/pr_184/p184_photo_3.JPG',
                    '/tmp_data/projects/pr_184/p184_photo_4.JPG',
                ],
                'layout' => [],
                'type' => 'Дом',
                'floors' => 2,
    ...
    [
        ...
        'seo_description' => 'Проект одноэтажного дома площадью 642 м² из газобетона. Современный дизайн и комфортное планировочное решение – доступно для строительства в [city|pp].',
    ],
    [
        'seo_title' => 'Компактный дом в стиле хай-тек SD-096 – проект в [city|pp]',
        'seo_description' => 'Двухэтажный дом площадью 1022 м² из газобетона. Лаконичная архитектура в стиле хай-тек и функциональная планировка для комфортной жизни в [city|pp].',
    ],
    [
        'seo_title' => 'Небольшой и уютный дом SD-103 – строительство в [city|pp]',
        'seo_description' => 'Практичный двухэтажный дом площадью 1112 м² из газобетона. Идеальный вариант для комфортного проживания семьи – возведение в [city|pp].',
    ],
    [
        'seo_title' => 'Каркасный двухэтажный дом с гаражом SD-359 – проект в [city|pp]',
        'seo_description' => 'Современный дом площадью 1182 м² с гаражом. Просторные планировки и надежные материалы для строительства в [city|pp].',
    ],
];
