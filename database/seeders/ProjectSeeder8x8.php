...
class ProjectSeeder8x8 extends Seeder
{
    ...
    [
        ...
        'seo_description' => 'Двухэтажный дом площадью 1012 м² из газобетона. Просторное решение для большой семьи с современным дизайном и комфортной планировкой. Реализуем строительство в [city|pp].',
    ],
    [
        'seo_title' => 'Двухэтажный каркасный коттедж с балконом SD-368 – заказать в [city|pp]',
        'seo_description' => 'Современный коттедж площадью 1282 м² с балконом. Каркасная технология и надежный газобетон обеспечивают долговечность и комфортное проживание в [city|pp].',
    ],
    [
        'seo_title' => 'Классический дом с двухскатной крышей SD-047 – строительство в [city|pp]',
        'seo_description' => 'Проект аккуратного двухэтажного дома площадью 1102 м². Двухскатная крыша, газобетонные стены и продуманная планировка – оптимальное решение для строительства в [city|pp].',
    ],
    [
        'seo_title' => 'Каркасный дом с камином SD-369 – проект в [city|pp]',
        'seo_description' => 'Просторный двухэтажный дом площадью 1282 м² из газобетона. Современный каркасный проект с уютным камином и удобной планировкой для жизни в [city|pp].',
    ],
    [
        'seo_title' => 'Коттедж с мансардой и террасой SD-157 – заказать строительство в [city|pp]',
        'seo_description' => 'Функциональный двухэтажный дом площадью 922 м². Коттедж из газобетона с мансардой и просторной террасой – отличное решение для проживания в [city|pp].',
    ],
];
