    ...
    public function run(): void
    {
        $data = [
            [
                ...
                'layout' => [['img' => '/tmp_data/projects/pr_136/p136_photo_2.JPG']],
                'type' => 'Дом',
                'floors' => 1,
                'total_area' => 100,
            ...
            [
                ...
                'gallery' => [
                    ['img' => '/tmp_data/projects/pr_137/p137_photo_1.JPG'],
                    ['img' => '/tmp_data/projects/pr_137/p137_photo_2.JPG'],
                ],
                'layout' => [['img' => '/tmp_data/projects/pr_137/p137_photo_3.JPG']],
                'type' => 'Дом',
                'floors' => 1,
                'total_area' => 98,
                'wall_material' => 'Каркасные дома',
            ...
            [
                ...
                'gallery' => [
                    ['img' => '/tmp_data/projects/pr_138/p138_photo_1.JPG'],
                    ['img' => '/tmp_data/projects/pr_138/p138_photo_2.JPG'],
                    ['img' => '/tmp_data/projects/pr_138/p138_photo_3.JPG'],
                    ['img' => '/tmp_data/projects/pr_138/p138_photo_4.JPG'],
                    ['img' => '/tmp_data/projects/pr_138/p138_photo_5.JPG'],
                    ['img' => '/tmp_data/projects/pr_138/p138_photo_6.JPG'],
                    ['img' => '/tmp_data/projects/pr_138/p138_photo_7.JPG'],
                    ['img' => '/tmp_data/projects/pr_138/p138_photo_8.JPG'],
                ],
                'layout' => [['img' => '/tmp_data/projects/pr_138/p138_photo_9.JPG']],
                'type' => 'Дом',
                'floors' => 2,
                'total_area' => 134,
            ...
            [
                ...
                'gallery' => [
                    ['img' => '/tmp_data/projects/pr_139/p139_photo_1.JPG'],
                    ['img' => '/tmp_data/projects/pr_139/p139_photo_2.JPG'],
                    ['img' => '/tmp_data/projects/pr_139/p139_photo_3.JPG'],
                    ['img' => '/tmp_data/projects/pr_139/p139_photo_4.JPG'],
                    ['img' => '/tmp_data/projects/pr_139/p139_photo_5.JPG'],
                ],
                'layout' => [['img' => '/tmp_data/projects/pr_139/p139_photo_6.JPG']],
                'type' => 'Дом',
                'floors' => 2,
                'total_area' => 100,
            ...
            [
                ...
                'gallery' => [
                    ['img' => '/tmp_data/projects/pr_140/p140_photo_1.JPG'],
                    ['img' => '/tmp_data/projects/pr_140/p140_photo_2.JPG'],
                    ['img' => '/tmp_data/projects/pr_140/p140_photo_3.JPG'],
                ],
                'layout' => [['img' => '/tmp_data/projects/pr_140/p140_photo_4.JPG']],
                'type' => 'Дом',
                'floors' => 2,
                'total_area' => 164,
                'wall_material' => 'Каркасные дома',
            ...
            [
                ...
                'gallery' => [
                    ['img' => '/tmp_data/projects/pr_141/p141_photo_1.JPG'],
                    ['img' => '/tmp_data/projects/pr_141/p141_photo_2.JPG'],
                    ['img' => '/tmp_data/projects/pr_141/p141_photo_3.JPG'],
                    ['img' => '/tmp_data/projects/pr_141/p141_photo_4.JPG'],
                    ['img' => '/tmp_data/projects/pr_141/p141_photo_5.JPG'],
                    ['img' => '/tmp_data/projects/pr_141/p141_photo_6.JPG'],
                    ['img' => '/tmp_data/projects/pr_141/p141_photo_7.JPG'],
                    ['img' => '/tmp_data/projects/pr_141/p141_photo_8.JPG'],
                ],
                'layout' => [['img' => '/tmp_data/projects/pr_141/p141_photo_9.JPG']],
                'type' => 'Дом',
                'floors' => 2,
                'total_area' => 143,
                'wall_material' => 'Газобетон',
        ...
        $seo_data = [
            [
                ...
                'seo_description' => 'Одноэтажный каркасный дом площадью 100 м² из газобетона. Современный проект для комфортной жизни, доступный для строительства в [city|pp].',
            ],
            [
                'seo_title' => 'Одноэтажный каркасный дом с террасой SD-357 – проект в [city|pp]',
                'seo_description' => 'Каркасный дом с просторной террасой общей площадью 98 м². Уютное решение для семьи, готовое к реализации в [city|pp].',
            ],
            [
                'seo_title' => 'Компактный мансардный коттедж SD-100 – строительство в [city|pp]',
                'seo_description' => 'Небольшой мансардный коттедж площадью 134 м² с красивым фасадом. Практичный выбор для загородной жизни в [city|pp].',
            ],
            [
                'seo_title' => 'Дом из бревна с мансардным этажом SD-266 – проект в [city|pp]',
                'seo_description' => 'Деревянный дом из оцилиндрованного бревна площадью 100 м². Экологичный и тёплый вариант для строительства в [city|pp].',
            ],
            [
                'seo_title' => 'Двухэтажный каркасный дом в стиле хай-тек SD-366 – строительство в [city|pp]',
                'seo_description' => 'Современный каркасный дом площадью 164 м² в стиле хай-тек. Простор и технологичность для комфортной жизни в [city|pp].',
            ],
            [
                'seo_title' => 'Стильный коттедж с жилой мансардой SD-200 – проект в [city|pp]',
                'seo_description' => 'Элегантный коттедж площадью 143 м² с жилой мансардой. Стильное решение для строительства в [city|pp].',
            ],
        ];
