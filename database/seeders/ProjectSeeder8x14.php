    ...
    public function run(): void
    {
        ...
        $seo_data = [
            [
                ...
                'seo_description' => 'Проект уютного двухэтажного дома площадью 1302 м² из профилированного бруса с собственной сауной. Современное решение для комфортной жизни и отдыха, доступное для реализации в [city|pp].',
            ],
            [
                'seo_title' => 'Двухэтажный дом из бревна с тремя спальнями SD-270 – проект в [city|pp]',
                'seo_description' => 'Просторный деревянный дом площадью 1092 м², выполненный из оцилиндрованного бревна. В проекте предусмотрены три спальни, удобные планировки и классический стиль – готов к строительству в [city|pp].',
            ],
            [
                'seo_title' => 'Современный жилой дом с гаражом и тремя спальнями SD-150 – строительство в [city|pp]',
                'seo_description' => 'Функциональный двухэтажный дом площадью 1482 м² из газобетона с гаражом и тремя спальнями. Идеальное сочетание практичности и современного дизайна, доступное для реализации в [city|pp].',
            ],
            [
                'seo_title' => 'Компактный коттедж на две семьи SD-149 – проект под ключ в [city|pp]',
                'seo_description' => 'Двухэтажный коттедж площадью 1582 м² из газобетона, рассчитанный на две семьи. Практичное и экономичное решение с современными планировками и высоким уровнем комфорта для строительства в [city|pp].',
            ],
        ];
