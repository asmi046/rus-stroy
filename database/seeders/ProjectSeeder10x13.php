    ...
    public function run(): void
    {
        ...
        $seo_data = [
            [
                ...
                'seo_description' => 'Просторный одноэтажный коттедж площадью 1022 м² из газобетона. Современное решение для комфортной жизни семьи в [city|pp].',
            ],
            [
                'seo_title' => 'Домик SD-062 — одноэтажный проект с чердаком из газобетона в [city|pp]',
                'seo_description' => 'Уютный одноэтажный домик 862 м² с небольшим чердаком. Практичный проект из газобетона для проживания и отдыха в [city|pp].',
            ],
            [
                'seo_title' => 'Двухэтажный дом SD-258 из бревна с парной в [city|pp]',
                'seo_description' => 'Надежный дом из оцилиндрованного бревна площадью 1652 м² с парной. Отличный выбор для ценителей натуральных материалов в [city|pp].',
            ],
            [
                'seo_title' => 'Коттедж SD-082 с мансардой и кирпичным фасадом в [city|pp]',
                'seo_description' => 'Стильный двухэтажный коттедж 1512 м² с оригинальной мансардой и кирпичным фасадом. Солидное решение для жизни в [city|pp].',
            ],
            [
                'seo_title' => 'Уютный коттедж SD-213 в традиционном стиле из газобетона в [city|pp]',
                'seo_description' => 'Дом 1822 м² с двускатной крышей и просторной планировкой. Газобетонный коттедж в классическом стиле для комфортного проживания в [city|pp].',
            ],
            [
                'seo_title' => 'Двухэтажный дом SD-034 с эркерами и балконами в [city|pp]',
                'seo_description' => 'Элегантный дом из газобетона площадью 2052 м². Эркеры и балконы придают фасаду выразительность. Современный проект для жизни в [city|pp].',
            ],
            [
                'seo_title' => 'Мансардный дом SD-009 с дополнительной спальней в [city|pp]',
                'seo_description' => 'Просторный дом 1902 м² из газобетона с мансардой и спальней на первом этаже. Удобный и практичный вариант для семьи в [city|pp].',
            ],
        ];
