...
class ProjectSeeder6x6 extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            [
                ...
                'gallery' => [
                    ['img' => '/tmp_data/projects/pr_104/p104_photo_1.JPG'],
                    ['img' => '/tmp_data/projects/pr_104/p104_photo_2.JPG'],
                    ['img' => '/tmp_data/projects/pr_104/p104_photo_3.JPG'],
                    ['img' => '/tmp_data/projects/pr_104/p104_photo_4.JPG'],
                ],
                'layout' => [['img' => '/tmp_data/projects/pr_104/p104_photo_5.JPG']],
                'type' => 'Дом',
                'floors' => 2,
                'total_area' => 61,
            ...
            [
                ...
                'gallery' => [
                    ['img' => '/tmp_data/projects/pr_105/p105_photo_1.JPG'],
                    ['img' => '/tmp_data/projects/pr_105/p105_photo_2.JPG'],
                    ['img' => '/tmp_data/projects/pr_105/p105_photo_3.JPG'],
                    ['img' => '/tmp_data/projects/pr_105/p105_photo_4.JPG'],
                ],
                'layout' => [['img' => '/tmp_data/projects/pr_105/p105_photo_5.JPG']],
                'type' => 'Дом',
                'floors' => 2,
                'total_area' => 49,
            ...
            [
                ...
                'gallery' => [
                    ['img' => '/tmp_data/projects/pr_106/p106_photo_1.JPG'],
                    ['img' => '/tmp_data/projects/pr_106/p106_photo_2.JPG'],
                    ['img' => '/tmp_data/projects/pr_106/p106_photo_3.JPG'],
                ],
                'layout' => [['img' => '/tmp_data/projects/pr_106/p106_photo_4.JPG']],
                'type' => 'Дом',
                'floors' => 2,
                'total_area' => 72,
                'wall_material' => 'Газобетон',
    ...
    [
        ...
        'seo_description' => 'Проект SD-297 – компактный двухэтажный дом из газобетона площадью 61 м². Идеален для небольшого участка: современная планировка, комфортное пространство и доступное строительство в [city|pp].',
    ],
    [
        'seo_title' => 'Маленький двухэтажный дом из бревна SD-264 – стильное решение для семьи',
        'seo_description' => 'SD-264 – уютный двухэтажный дом из клеёного бруса площадью 49 м². Теплый, экологичный и функциональный проект, который станет отличным выбором для комфортного проживания в [city|pp].',
    ],
    [
        'seo_title' => 'Двухэтажный дом с мансардой SD-298 – проект для строительства в [city|pp]',
        'seo_description' => 'Проект SD-298 – современный двухэтажный дом из газобетона площадью 72 м² с удобной мансардой. Отличный вариант для семьи, объединяющий простор и рациональное использование участка в [city|pp].',
    ],
];
