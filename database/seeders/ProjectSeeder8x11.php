    ...
    public function run(): void
    {
        ...
        $seo_data = [
            [
                ...
                'seo_description' => 'Современный двухэтажный дом из газобетона площадью 1892 м² с гардеробной и постирочной комнатой. Удобное решение для семьи, доступное для реализации в [city|pp].',
            ],
            [
                'seo_title' => 'Одноэтажный компактный дом SD-375 – проект в [city|pp]',
                'seo_description' => 'Уютный одноэтажный дом из газобетона площадью 762 м². Практичное и доступное решение для строительства в [city|pp].',
            ],
            [
                'seo_title' => 'Одноэтажный коттедж из газобетона SD-376 – строительство в [city|pp]',
                'seo_description' => 'Комфортный одноэтажный коттедж площадью 762 м² из газобетона. Отличный выбор для загородной жизни в [city|pp].',
            ],
            [
                'seo_title' => 'Одноэтажный дачный дом SD-374 – проект под ключ в [city|pp]',
                'seo_description' => 'Просторный одноэтажный дачный дом из газобетона площадью 882 м². Подходит для сезонного и постоянного проживания в [city|pp].',
            ],
            [
                'seo_title' => 'Дом из газобетона с мансардой SD-377 – строительство в [city|pp]',
                'seo_description' => 'Двухэтажный дом с мансардой и эркером, площадь 1232 м². Эстетика и функциональность из газобетона для жизни в [city|pp].',
            ],
            [
                'seo_title' => 'Двухэтажный дом с гаражом SD-378 – проект в [city|pp]',
                'seo_description' => 'Современный дом из газобетона площадью 1362 м² с удобным встроенным гаражом. Практичное решение для строительства в [city|pp].',
            ],
        ];
