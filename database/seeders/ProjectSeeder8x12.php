    ...
    public function run(): void
    {
        ...
        $seo_data = [
            [
                ...
                'seo_description' => 'Компактный одноэтажный дом площадью 742 м² из газобетона. Удобное решение с двумя спальнями для комфортного проживания семьи, доступное для реализации в [city|pp].',
            ],
            [
                'seo_title' => 'Одноэтажный дом с террасой SD-347 – проект в [city|pp]',
                'seo_description' => 'Проект одноэтажного дома площадью 922 м² из профилированного бруса с уютной террасой. Стильное и практичное решение для строительства в [city|pp].',
            ],
            [
                'seo_title' => 'Уютный домик в стиле прованс SD-346 – строительство в [city|pp]',
                'seo_description' => 'Одноэтажный дом площадью 822 м² из газобетона, выполненный в стиле прованс. Эстетика и функциональность для комфортной жизни в [city|pp].',
            ],
            [
                'seo_title' => 'Двухэтажный дом с баней SD-252 – проект под ключ в [city|pp]',
                'seo_description' => 'Просторный дом площадью 1442 м² из профилированного бруса с собственной баней. Отличное решение для семейного отдыха и постоянного проживания в [city|pp].',
            ],
            [
                'seo_title' => 'Классический коттедж с комнатой на первом этаже SD-051 – строительство в [city|pp]',
                'seo_description' => 'Двухэтажный коттедж площадью 1382 м² из газобетона с удобной планировкой и комнатой на первом этаже. Классическое решение для комфортной жизни в [city|pp].',
            ],
        ];
