...
class ProjectSeeder6x8 extends Seeder
{
    ...
    [
        ...
        'seo_description' => 'Проект SD-302 – современный одноэтажный дом из газобетона площадью 772 м². Панорамные окна наполняют интерьер светом, а компактные размеры делают его отличным выбором для небольшого участка в [city|pp].',
    ],
    [
        'seo_title' => 'Дом с мансардным этажом и балконом SD-318 – стильный проект в [city|pp]',
        'seo_description' => 'SD-318 – просторный двухэтажный дом площадью 962 м². Мансардный этаж, удобный балкон и современная планировка обеспечивают уют и функциональность. Подходит для строительства в [city|pp].',
    ],
    [
        'seo_title' => 'Дом с мансардным этажом и крышей сложной формы SD-313 – проект под [city|pp]',
        'seo_description' => 'Проект SD-313 – изящный дом из газобетона площадью 712 м². Разноуровневая крыша и мансардный этаж придают дому индивидуальность и современный облик. Отличный вариант для реализации в [city|pp].',
    ],
    [
        'seo_title' => 'Двухэтажный дом с эркером и гаражом SD-300 – проект для комфортной жизни в [city|pp]',
        'seo_description' => 'SD-300 – солидный двухэтажный дом общей площадью 1542 м². Эркер добавляет эстетики, а встроенный гараж делает дом максимально удобным для семьи. Подходит для строительства в [city|pp].',
    ],
    [
        'seo_title' => 'Двухэтажный дом с четырьмя спальнями и гаражом SD-301 – готовый проект в [city|pp]',
        'seo_description' => 'Проект SD-301 – функциональный двухэтажный дом площадью 972 м². Четыре спальни обеспечат комфорт большой семьи, а гараж добавит практичности. Доступен для строительства в [city|pp].',
    ],
    [
        'seo_title' => 'Двухэтажный дом для небольшого участка с постирочной SD-299 – проект в [city|pp]',
        'seo_description' => 'SD-299 – современный дом из газобетона площадью 1012 м². Компактное решение с постирочной и рациональной планировкой идеально подходит для небольшого участка в [city|pp].',
    ],
];
