    ...
    public function run(): void
    {
        ...
        $seo_data = [
            [
                ...
                'seo_description' => 'Проект стильного одноэтажного дома площадью 732 м² с четырехскатной крышей. Комфортное и современное решение для семьи, доступное для строительства в [city|pp].',
            ],

            [
                'seo_title' => 'Дом с панорамными окнами в столовой PD-209 – проект в [city|pp]',
                'seo_description' => 'Просторный двухэтажный дом площадью 1802 м² с панорамным остеклением. Эстетика и уют в современном стиле – готов к реализации в [city|pp].',
            ],

            [
                'seo_title' => 'Дом со скатной крышей в скандинавском стиле DS-02 – проект в [city|pp]',
                'seo_description' => 'Одноэтажный дом площадью 902 м² в минималистичном скандинавском стиле. Практичное и стильное решение для строительства в [city|pp].',
            ],

            [
                'seo_title' => 'Двухэтажный дом со вторым светом DS-03/1 – современный проект в [city|pp]',
                'seo_description' => 'Современный проект DS-03/1: просторный дом площадью 1402 м² с эффектным вторым светом. Стильное и надежное жильё для комфортной жизни в [city|pp].',
            ],

            [
                'seo_title' => 'Небольшой одноэтажный дом с тремя спальнями PD-101 – проект в [city|pp]',
                'seo_description' => 'Уютный дом PD-101 площадью 762 м². Три спальни, продуманная планировка и современные материалы – практичное решение для строительства под ключ в [city|pp].',
            ],

            [
                'seo_title' => 'Мансардный дом с двухскатной крышей PD-091 – проект в [city|pp]',
                'seo_description' => 'Проект PD-091: стильный мансардный дом площадью 1532 м² с двухскатной крышей. Комфортное и надёжное жильё, готовое для реализации в [city|pp].',
            ],
        ];
