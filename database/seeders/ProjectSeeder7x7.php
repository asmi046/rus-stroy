...
class ProjectSeeder7x7 extends Seeder
{
    ...
    [
        ...
        'seo_description' => 'Проект SD-268 – одноэтажная сауна из оцилиндрованного бревна площадью 482 м². Компактное решение для загородного отдыха и комфортного использования в [city|pp].',
    ],
    [
        'seo_title' => 'Небольшой двухэтажный дом с парной SD-263 – стильное решение',
        'seo_description' => 'Проект SD-263 – двухэтажный дом из оцилиндрованного бревна площадью 502 м². Уютная планировка и парная для полноценного отдыха в загородном доме в [city|pp].',
    ],
    [
        'seo_title' => 'Двухэтажный дом из бревна с мансардным этажом SD-265 – просторный проект',
        'seo_description' => 'Проект SD-265 – дом из оцилиндрованного бревна с мансардным этажом площадью 572 м². Функциональное пространство и классический стиль для строительства в [city|pp].',
    ],
    [
        'seo_title' => 'Двухэтажный каркасный дом SD-354 – современный проект для комфортной жизни',
        'seo_description' => 'Проект SD-354 – каркасный дом из газобетона площадью 782 м². Просторные комнаты, современный дизайн и практичная планировка – идеальный выбор в [city|pp].',
    ],
    [
        'seo_title' => 'Дом с мансардным этажом SD-328 – удобный проект для семьи',
        'seo_description' => 'Проект SD-328 – двухэтажный дом из газобетона с мансардным этажом площадью 722 м². Удобная планировка и гармоничная архитектура для строительства в [city|pp].',
    ],
    [
        'seo_title' => 'Двухэтажный дом с мансардой SD-330 – функциональный проект',
        'seo_description' => 'Проект SD-330 – двухэтажный дом из газобетона с мансардой площадью 712 м². Продуманное зонирование и комфорт для проживания в [city|pp].',
    ],
    [
        'seo_title' => 'Красивый двухэтажный дом с балконом SD-329 – современный проект',
        'seo_description' => 'Проект SD-329 – дом из газобетона площадью 942 м² с просторным балконом. Уютная атмосфера и стильный фасад для строительства в [city|pp].',
    ],
    [
        'seo_title' => 'Дачный двухэтажный каркасный дом SD-355 – компактное решение',
        'seo_description' => 'Проект SD-355 – каркасный дом из газобетона площадью 942 м². Отличный вариант для дачи или загородного проживания в [city|pp].',
    ],
    [
        'seo_title' => 'Уютный двухэтажный каркасный дом SD-356 – просторный проект',
        'seo_description' => 'Проект SD-356 – двухэтажный каркасный дом из газобетона площадью 1042 м². Просторные комнаты, современная планировка и комфортное проживание в [city|pp].',
    ],
];
